...
public class IssuerWebService extends Service {
    ...
    public final static QName IssuerWebServiceSoap12 = new QName("https://paysecure/merchant.soap/", "IssuerWebServiceSoap12");
    static {
     ...
     *     returns IssuerWebServiceSoap
     */
    @WebEndpoint(name = "IssuerWebServiceSoap12")
    public IssuerWebServiceSoap getIssuerWebServiceSoap12() {
        return super.getPort(IssuerWebServiceSoap12, IssuerWebServiceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "IssuerWebServiceSoap12")
    public IssuerWebServiceSoap getIssuerWebServiceSoap12(WebServiceFeature... features) {
        return super.getPort(IssuerWebServiceSoap12, IssuerWebServiceSoap.class, features);
    }
